...
gauge = {
{
    ...
    graph_bg_colour=0x00C4FF,      graph_bg_alpha=0.3,
    graph_fg_colour=0x00C4FF,      graph_fg_alpha=0.0,
    hand_fg_colour=0x00C4FF,       hand_fg_alpha=1.0,
    txt_radius=40,
    txt_weight=1,                  txt_size=10.0,
    txt_fg_colour=0x00C4FF,        txt_fg_alpha=0.8,
    graduation_radius=30,
    graduation_thickness=0,        graduation_mark_thickness=1,
    graduation_unit_angle=27,
    graduation_fg_colour=0x00C4FF, graduation_fg_alpha=0.3,
    caption='',
